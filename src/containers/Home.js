...
const Home = () => (
  <div className="flex flex-col lg:mt-1 mt-32">
    <div className="flex flex-col items-center">
      ...
      <h1 className="text-white  lg:text-2xl sm:text-4xl text-2xl font-bold mt-4">Paul Clevlin</h1>
      <p className="text-white font-light lg:text-base sm:text-2xl text-base mt-4">Dentist</p>
    </div>
